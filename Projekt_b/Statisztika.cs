...
namespace Projekt_b
{
    internal class Statisztika
    {
        public static void Stat()
        {
            ...
            {
                if (x.Nev.Contains("intel", StringComparison.CurrentCultureIgnoreCase) && x.Tipus == "processzor")
                    intel_db++;
                else if (x.Nev.Contains("amd", StringComparison.CurrentCultureIgnoreCase) && x.Tipus == "processzor")
                    amd_db++;
